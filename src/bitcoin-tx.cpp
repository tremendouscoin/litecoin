...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s tremendouscoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  tremendouscoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded tremendouscoin transaction") + "\n" +
              "  tremendouscoin-tx [options] -create [commands]   " + _("Create hex-encoded tremendouscoin transaction") + "\n" +
              "\n";
