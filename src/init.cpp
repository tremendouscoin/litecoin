...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/tremendouscoin-project/tremendouscoin>";
    const std::string URL_WEBSITE = "<https://tremendouscoin.org>";
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("Tremendouscoin version %s\n", FormatFullVersion());
}
